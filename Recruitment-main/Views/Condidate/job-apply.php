...
if(isset($_SESSION['email'])){
    $pro = $user->GetProfile($_SESSION['email']);
}
if(isset($_GET['jobid'])){
...
if(isset($_POST['send'])){
    $job->AddApp($_POST,$_GET['jobid'],$_SESSION['id']);
}
...
<!-- Mirrored from shreethemes.in/jobnova/layouts/job-apply.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 13:09:24 GMT -->
<head>
		<meta charset="UTF-8">
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <img src="../images/company/lenovo-logo.png" class="avatar avatar-small rounded-pill p-2 bg-white" alt="">
                            <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark mt-3"><?php echo $j['job_name'];?></h5>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="position-middle-bottom">
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb breadcrumb-muted mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="job-grid-four.php">Job</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="card border-0">
                            <form class="rounded shadow p-4" method="POST">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Votre Nom et Prenom :<span class="text-danger">*</span></label>
                                            <input name="name" id="name2" type="text" class="form-control" value="<?php echo $cl['prenom'], ' ' , $cl['nom'];?>">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Your Email :<span class="text-danger">*</span></label>
                                            <input name="email" id="email2" type="email" class="form-control" value="<?php echo $cl['email'];?>">
                                        </div> 
                                    </div><!--end col-->
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Your Phone no. :<span class="text-danger">*</span></label>
                                            <input name="tel" id="number2" type="text" class="form-control" value="<?php echo $pro['tel'];?>">
                                        </div> 
                                    </div><!--end col-->
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Job Title :</label>
                                            <input name="job_name" id="subject2" class="form-control" value="<?php echo $j['job_name']?> ">
                                        </div>                                                                               
                                    </div><!--end col-->
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Types of jobs :</label>
                                            <select class="form-control form-select" id="Sortbylist-Shop" name="type_job">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="lettre" id="comments2" rows="4" class="form-control" placeholder="Describe the job :"></textarea>
                                        </div>
                                    </div><!--end col-->                                    
                                    <div class="col-12">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="submit" id="submit2" name="send" class="submitBnt btn btn-primary" >Apply Now</button>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </form><!--end form-->
                        </div><!--end custom-form-->
